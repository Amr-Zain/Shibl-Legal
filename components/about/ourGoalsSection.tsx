...
async function OurGoalsSection() {
  ...
  return (
    <section data-aos="fade-down" className="mb-16 grid grid-cols-1 lg:grid-cols-[380px_1fr] gap-4 px-2 sm:px-6 lg:px-8">
      <div  className="hidden lg:block md:relative rounded-3xl h-full bg-cover bg-no-repeat">
        <Image
          src={HAMMER}
          alt=""
          className="relative z-[1] w-full h-full max-w-[100%]"
        />
      {/*   <Image
          src={JUST}
          alt=""
